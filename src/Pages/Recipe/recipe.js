...
import { MainButton, BasicButton } from "../../common/button";
      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <FruitVegetable>
              {/* 이번주 추천 채소, 과일 페이지 설정 */}
              <MainButton width={"200px"}>두리안</MainButton>
              <MainButton width={"200px"}>불로초</MainButton>
              <MainButton width={"200px"}>산삼</MainButton>
              <MainButton width={"200px"}>코코넛</MainButton>
              {/* 코코넛 */}
            </FruitVegetable>
          </div>
        </div>
